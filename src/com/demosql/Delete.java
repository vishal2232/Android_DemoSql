...
public class Delete extends Activity {
	...
	EditText e1;
	Button b1;
	String id,fname1,lname1;
	int check=0;
	 //MyDb mydb=new MyDb(Delete.this);
    @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(check==1)
				{
					MyDb mydb1=new MyDb(Delete.this);
					SQLiteDatabase database1= mydb.getWritableDatabase();
					long a=database1.delete("demotable", "id="+id, null);
					if(a>0){
					...
					/*Intent i =new Intent(Delete.this,UpdateProcess.class);
					i.putExtra("id", id);
